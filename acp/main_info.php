	...
	function module()
	{
		return array(
			...
			'modes'		=> array(
				...
				'digests_mass_subscribe_unsubscribe'	=> array('title' => 'ACP_DIGESTS_MASS_SUBSCRIBE_UNSUBSCRIBE', 'auth' => 'ext_phpbbservices/digests && acl_a_board', 'cat' => array('ACP_CAT_DIGESTS')),
				'digests_test'							=> array('title' => 'ACP_DIGESTS_TEST', 'auth' => 'ext_phpbbservices/digests && acl_a_board', 'cat' => array('ACP_CAT_DIGESTS')),
				'digests_reset_cron_run_time'			=> array('title' => 'ACP_DIGESTS_RESET_CRON_RUN_TIME', 'auth' => 'ext_phpbbservices/digests && acl_a_board', 'cat' => array('ACP_CAT_DIGESTS')),
			),
		);
	}
}
