...
$lang = array_merge($lang, array(
   ...
   'DIGESTS_HAS_UNSUBSCRIBED'                        => 'Abonnement beendet',
   'DIGESTS_HOUR_SENT'                              => 'Sendeuhrzeit<br />(GMT [+] %s)',
   'DIGESTS_IGNORE'                              => 'Keine Änderung vornehmen',
   ...
   'DIGESTS_NOTIFY_ON_MASS_SUBSCRIBE'                  => 'Nutzer via eMail benachrichtigen, wenn sie betroffen sind',
   ...
   'LOG_CONFIG_DIGESTS_LOG_ENTRY_GOOD'                  => '<strong>eMail-Zusammnestellung %s %s (%s) mit %s Beiträgen and %s Private Nachrichten</strong>',
   ...
   'LOG_CONFIG_DIGESTS_LOG_ENTRY_GOOD_NO_EMAIL'         => '<strong>eMail-Zusammnestellung %s %s mit %s Beiträgen and %s Private Nachrichten</strong>',
