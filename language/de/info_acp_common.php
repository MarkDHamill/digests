...
$lang = array_merge($lang, array(
	...
	'DIGESTS_HOUR_SENT'										=> 'Sendeuhrzeit<br />(GMT [+] %s)',
	...
	'DIGESTS_LIST_USER'     								=> 'Es wird nur ein Nutzer angezeigt ',
	'DIGESTS_LIST_USERS'    								=> 'Es werden insgesamt %s Nutzer aufgelistet |',
	...
	'DIGESTS_MAILER_SPOOLED'								=> 'Die für diesen Tag und diese Stunde vorgesehenen Zusammenfassungen wurden im Cache-Ordner der Extension gespeichert (/ext/phpbbservices/digests/cache).',
	...
	'DIGESTS_NOTIFY_ON_ADMIN_CHANGES'						=> 'Nutzer per eMail über administrative Änderungen an ihrer Zusammenstellung benachrichtigen',
	'DIGESTS_NOTIFY_ON_ADMIN_CHANGES_EXPLAIN'				=> 'In den Menü-Bereichen \'Abonnements verwalten\', \'Last-Verteilung\' und \'Massen-Abonnement\' können Administartoren Änderungen an den nutzerspezifischen Einstellungen ihrer Zusammenfassungen bewirken. Bei der Auswahl von \'Ja\' werden die Nutzer per Email auf die von den Adminstratoren hervorgerufenen Änderungen an ihren Zusammenfassungseinstellungen hingewiesen.',
	...
	'DIGESTS_RUN_TEST_CLEAR_SPOOL_EXPLAIN'					=> '\'Ja\' bedeutet, dass alle Dateien im Cache-Ordner der Extension gelöscht werden. Diese Einstellung ist sinnvoll, um auszuschließen, dass noch auf alte Zusammenfassungen zugegriffen werden kann, während bereits neue Zusammenfassungen im Cache abgelegt werden.',
	'DIGESTS_RUN_TEST_DAY'									=> 'Simulierter Kalendertag',
	'DIGESTS_RUN_TEST_DAY_EXPLAIN'							=> 'Ganze Zahl zwischen 1 und 31. Wenn Jahr, Monat und Kalendertag in der Zukunft liegen, wird die Zusammenfassung natürlich leer bleiben. Unlogische Eingaben, wie z.B. \'31. Februar\' werden nicht akzeptiert.',
	...
	'DIGESTS_RUN_TEST_HOUR_EXPLAIN'							=> 'Die Zusammenfassungen, die für die hier angegebene Stunde geplant sind oder waren, werden im Rahmen der Simulation erzeugt und versandt. Die zeit bezieht sich auf die Zeitzoneneinstellung des Boards (GMT [+] ' . $timeOffset . '). Liegt dieser Zeitpunkt in der Zukunft, so können die Zusammenfassungen keine Beiträge enthalten. Erlaubt sind ganze Zahlen zwischen 0 und 23.',
	'DIGESTS_RUN_TEST_MONTH'								=> 'Simulierter Monat',
	'DIGESTS_RUN_TEST_MONTH_EXPLAIN'						=> 'Ganzzahliger Wert von 1 bis 12. Meist ist es sinnvoll, den gegenwärtigen Monat zu wählen. Wenn Jahr und Monat in der Zukunft liegen, können die Test-Zusammenfassungen keinen Inhalt erhalten.',
	...
	'DIGESTS_RUN_TEST_YEAR_EXPLAIN'							=> 'Es sind nur Jahre zwischen 2000 und 2030 erlaubt. Es wird empfohlen das aktuelle Jahr zu nehmen. Liegt das Jahr in der Zukunft, so werden die Zusammenfassungen natürlich ohne Inhalt sein.',
	...
	'DIGESTS_SUBSCRIBE_EDITED'								=> 'Deine Einstellungen für den Versand der Zusammenfassungen wurden geändert.',
	...
	'DIGESTS_USER_DIGESTS_SEND_HOUR_GMT'					=> 'Standard-Sendezeit (Universal Time)',
	...
	'DIGESTS_USERS_PER_PAGE_EXPLAIN'						=> 'Hier wird eingestellt, wie viele Nutzer-Zeilen pro Seite in der Abonnement-Verwaltung angezeigt werden sollen.',
	...
	'LOG_CONFIG_DIGESTS_CACHE_CLEARED'						=> '<strong>Der Cache der Digest-Extension wurde geleert',
	'LOG_CONFIG_DIGESTS_CLEAR_SPOOL_ERROR'					=> '<strong>Es konnten nicht alle Dateien aus dem Cache-Ordner entfernt werden. Ursache könnten fehlende Datei-Rechte sein. Alle Dateien sollten \'publicly writeable\' sein (777 auf Unix-basierten Systemen).</strong>',
	...
	'LOG_CONFIG_DIGESTS_LOG_ENTRY_GOOD'						=> '<strong>eMail-Zusammnestellung %s %s (%s) mit %s Beiträgen und %s Privaten Nachricht(en)</strong>',
	'LOG_CONFIG_DIGESTS_LOG_ENTRY_GOOD_DISK'				=> '<strong>Es wurde eine eMail-Zusammnestellung mit dem Dateinamen %s im Cache-Ordner abgespeichert. Die Zusammenfassung wurde nicht per eMail versandt, sondern dort für Prüfzwecke hinterlegt.</strong>',
	'LOG_CONFIG_DIGESTS_LOG_ENTRY_GOOD_NO_EMAIL'			=> '<strong>eMail-Zusammnestellung %s %s mit %s Beiträgen und %s Privaten Nachricht(en)</strong>',
	...
	'LOG_CONFIG_DIGESTS_NOTIFICATION_ERROR'					=> '<strong>Ein durch administrative Veränderungen an den Zusammenfassungseinstellungen ausgelöste Nutzer-Benachrichtigung an %s konnte nicht gesendet werden.</strong>',
	'LOG_CONFIG_DIGESTS_NOTIFICATION_SENT'					=> '<strong>Es wurde eine Email an %s (%s) mit dem hinweis auf Änderungen an den Zusammenfassungseinstellungen versandt</strong>',	
 	'LOG_CONFIG_DIGESTS_RUN_TOO_SOON'						=> '<strong>Es ist Weniger als eine Stunde seit dem letzten Zusammenfassungsversand vergangen. Die Startprozedur wurde wieder abgebrochen.</strong>',
