...
$lang = array_merge($lang, array(
	...
	'DIGESTS_CLEAR_CACHE_NOT_RUN'							=> 'Cached digests were not removed because this feature was not selected',
	'DIGESTS_CLEAR_REPORT'									=> 'Clear report statistics',
	'DIGESTS_CLEAR_REPORT_EXPLAIN'							=> 'Removes all mailing report statistics collected.',
	'DIGESTS_CLEAR_REPORT_NOT_RUN'							=> 'Report statistics were not removed because this feature was not selected',
	'DIGESTS_CLEAR_REPORT_RUN'								=> 'Report statistics were removed',
	'DIGESTS_COLLAPSE'										=> 'Collapse user’s digest settings',
	...
	'DIGESTS_CRON_TYPE'										=> 'Cron type',
	'DIGESTS_CRON_TYPE_MANUAL'								=> 'Manual (ACP)',
	'DIGESTS_CRON_TYPE_PHPBB'								=> 'phpBB',
	'DIGESTS_CRON_TYPE_SYSTEM'								=> 'System',
	...
	'DIGESTS_CUSTOM_STYLESHEET_PATH_EXPLAIN'				=> 'This setting only applies if the enable custom stylesheet box is enabled. If it is enabled, this stylesheet will be applied to all styled digests. The path should be a relative path from your phpBB styles folder and should normally be in the theme subfolder. <em>Note</em>: you are responsible for creating this stylesheet and placing it in a file with the name entered here on the appropriate location on your server. Example: prosilver/theme/digest_stylesheet.css. For information on creating stylesheets, click <a href="http://www.w3schools.com/css/">here</a>.',
	'DIGESTS_DATE_HOUR'										=> 'Date and hour (UTC)',
	...
	'DIGESTS_ENABLE_LOG_EXPLAIN'							=> 'If this is enabled, all digest actions will be written to the admin log (found on the maintenance tab). This is helpful for answering digest questions since it indicates what the digests&rsquo; mailer did, when and for which subscribers. But enabling this will quickly result in a very long admin log since at least two entries will be written every hour to the log. <em>Note</em>: errors, exceptions and warnings are always written to phpBB&rsquo;s error log.',
	...
	'DIGESTS_EXECUTION_TIME'								=> 'Execution time (sec)',
	'DIGESTS_EXPAND'										=> 'Expand user’s digest settings',
	...
	'DIGESTS_IGNORE'										=> 'Ignore any checked rows',
	...
	'DIGESTS_MAX_CRON_HOURS_EXPLAIN'						=> 'Set this to 0 (zero) to process all digests for all hours in the queue when the mailer is run. However, if you have shared hosting then running the mailer may trigger resource limits and cause the mailer to error. This is more likely to happen if you have many subscribers and board traffic is light. Setting up a <a href="https://wiki.phpbb.com/PhpBB3.1/RFC/Modular_cron#Use_system_cron">system cron</a> is the easiest way to minimize this issue and should also ensure the timely arrival of digests.',
	...
	'DIGESTS_MAILED'		 								=> 'Digests mailed',
	'DIGESTS_MAILER_RESET' 									=> 'The digest’s mailer was reset',
	'DIGESTS_MANAGE_THIS_USER'								=> 'Manage this user',
	'DIGESTS_MEMORY_USED'									=> 'Memory used (MB)',
	...
	'DIGESTS_NO_SUBSCRIBERS'								=> '<em>No subscribers</em>',
	...
	'DIGESTS_PROCESS_ENDED'									=> 'Process ended',
	'DIGESTS_PROCESS_STARTED'								=> 'Process started',
	...
	'DIGESTS_REPORTING_DAYS'								=> 'Maximum days of report statistics',
	'DIGESTS_REPORTING_DAYS_EXPLAIN'						=> 'Digests reporting statistics can consume a lot of database space. This limits the number of days of statistics that are collected for reporting statistics. Statistics older than this are automatically deleted when the mailer is run. Enter 0 (zero) to allow unlimited number of days of statistics.',
	'DIGESTS_REPORTING_ENABLE'								=> 'Enable reporting',
	'DIGESTS_REPORTING_ENABLE_EXPLAIN'						=> 'When enabled, reports are kept when digests are sent out showing hourly statistics of email sent and some performance information.',
	...
	'DIGESTS_ROWS_PER_PAGE'									=> 'Rows per page',
	'DIGESTS_ROWS_PER_PAGE_EXPLAIN'							=> 'This controls how many rows per page appear in a table of data. It is recommended you leave this at 20. Setting this value too high may trigger a PHP max_input_vars error on the Edit subscribers page.',
	...
	'DIGESTS_RUN_TEST_DATE_HOUR_EXPLAIN'					=> 'Use the date and hour picker control to select a date and hour. The date and time you select will be interpreted based on your timezone set in your user profile (%s). If this was previously run, the date and hour last run is shown. Otherwise the current date and hour is set.',
	'DIGESTS_RUN_TEST_EMAIL_ADDRESS'						=> 'Test email address',
	'DIGESTS_RUN_TEST_EMAIL_ADDRESS_EXPLAIN'				=> 'If an email address is specified in this field, all digests for the requested hour will be sent to this email address instead of the board contact email address (%s). <em>Note</em>: if you elected to send emails to files, this field is ignored.',
	'DIGESTS_RUN_TEST_SEND_TO_ADMIN'						=> 'Send all digests to the email address specified',
	'DIGESTS_RUN_TEST_SEND_TO_ADMIN_EXPLAIN'				=> 'If you want to email the digests in the test, all digests will be emailed to the address specified in the field below. <em>Note</em>: if you elected to send emails to files, this setting is ignored. If yes, but no email address is specified, the board contact email address (%s) will be used. <em>Caution</em>: certain email servers may interpret a large volume of emails in a short period of time from the same address as spam or inappropriate use. Enable with care. If you say no, then digests will actually be mailed to subscribers, which may confuse them.',
	...
	'DIGESTS_SEARCH_FOR_MEMBER_EXPLAIN'						=> 'Enter the full or partial member name or email address to look for, then press return. Leave blank to disable this kind of search. Member name searches are not case sensitive. <em>Note</em>: There must be an @ symbol in the field for an email search to be performed.',
	...
	'DIGESTS_SKIPPED'										=> 'Digests skipped',
