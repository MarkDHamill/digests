...
$lang = array_merge($lang, array(
	...
	'DIGESTS_LOWERCASE_DIGEST_TYPE_EXPLAIN'					=> 'In English, the title of the digest will be something like "My board name Daily Digest". In certain languages "Digest Daily" will logically precede the board name. If set to yes, then the digest type will appear something like "Digest daily of my board name", with the first letter of the board name in lowercase.',
	...
	'DIGESTS_SHOW_FORUM_PATH_EXPLAIN'						=> 'If enabled, digest forum names will show the categories and forums a forum is nested within, for example: "Category 1 :: Forum 1 :: Category A :: Forum B", going as deep as categories and forums are nested on your board. Otherwise only the name of the forum containing will be shown, "Forum B" in this example.',
	'DIGESTS_SORT_ORDER'									=> 'Sort order',
	'DIGESTS_STOPPED_SUBSCRIBING'							=> 'Has unsubscribed',
	'DIGESTS_STRIP_TAGS'									=> 'Tags to strip from digests',
	'DIGESTS_STRIP_TAGS_EXPLAIN'							=> 'The presence of certain HTML tags in digests may cause issues. Mail servers may reject emails or blacklist senders containing certain HTML tags, or place digests in a spam mail folder. Type the name of the tags (without &lt; or &gt; characters) to exclude and separated by commas. For example, to remove the video and iframe tags, enter "video,iframe" in this field. Avoid entering common tags like h1, p and div as these are essential to rendering digests.',
