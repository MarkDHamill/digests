...
$lang = array_merge($lang, array(
	...
	'DIGESTS_SEARCH_FOR_MEMBER_EXPLAIN'						=> 'Enter the full or partial member name or email address to look then press Return or Enter. Leave blank to see all members. Member name searches are not case sensitive. <em>Note</em>: If there must be an @ symbol in the field for an email search to be performed.',
