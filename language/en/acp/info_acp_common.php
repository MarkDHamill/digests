...
$lang = array_merge($lang, array(
	...
	'ACP_DIGESTS_TEST_EXPLAIN'								=> 'This feature allows you to manually run digests for initial testing or troubleshooting. You can also use it to recreate digests for hours when they may not have been sent. Only one hour of digests are created and no user data are changed.<br><br> <strong>Subscribers that might receive digests for the current hour:</strong> %s',
	...
	'LOG_CONFIG_DIGESTS_CACHE_CLEARED'						=> '<strong>The store/phpbbservices/digests folder was emptied</strong>',
	'LOG_CONFIG_DIGESTS_CLEAR_REPORT'						=> '<strong>Cleared digests reports statistics</strong>',
	...
	'LOG_CONFIG_DIGESTS_EMAILING_FAILURE'					=> '<strong>Unable to email digests for date %1$s hour %2$d UTC. Execution time: %3$s of %4$d allowed seconds. %5$s MB of memory was used. A total of %6$u digests were emailed, %7$u digests were skipped and %8$u hours were processed before the mailer was aborted.</strong>',
	'LOG_CONFIG_DIGESTS_EMAILING_SUCCESS'					=> '<strong>Emailed digests for date %1$s hour %2$d UTC. Execution time: %3$s of %4$d allowed seconds. %5$s MB of memory was used. A total of %6$u digests were emailed, %7$u digests were skipped and %8$u hours were processed.</strong>',
	...
	'LOG_CONFIG_DIGESTS_LOG_END'							=> '<strong>Ending digests mailer. A total of %1$u digests were emailed and %2$u digests were skipped.</strong>',
	...
	'LOG_CONFIG_DIGESTS_LOG_ENTRY_GOOD'						=> array(
		...
		2 => '<strong>A %1$s digest was %2$s %3$s (%4$s) for date %5$s and hour %6$02d UTC containing %7$d posts and %8$d private messages</strong>',
	),
