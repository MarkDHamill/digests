...
$lang = array_merge($lang, array(
	...
	'LOG_CONFIG_DIGESTS_CACHE_CLEARED'						=> '<strong>The cache/phpbbservices/digests folder was emptied',
	'LOG_CONFIG_DIGESTS_CLEAR_SPOOL_ERROR'					=> '<strong>Unable to clear files in the cache/phpbbservices/digests folder. This may be due to a permissions issue or an incorrect path. The file permissions on the folder should be set to publicly writeable (777 on Unix-based systems).</strong>',
	...
	'LOG_CONFIG_DIGESTS_SIMULATION_DATE_TIME'				=> '<strong>Administrator chose to create digests for %1$s at %2$02d:00 board time.</strong>',
