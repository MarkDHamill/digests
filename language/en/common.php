...
$lang = array_merge($lang, array(
	...
	'DIGESTS_DISCLAIMER'				=> 'This digest is being sent to registered members of <a href="%s">%s</a> forums. You can change or delete your subscription from the forum&apos;s <a href="%sucp.%s">User Control Panel</a>. If you have questions or feedback on the format of this digest please send it to the <a href="mailto:%s?subject=Digests">%s webmaster</a>.',
	'DIGESTS_EXCEPTION'					=> 'Uncaught exception while running digests mailer: ',
	'DIGESTS_EXPLANATION'				=> 'Digests are email summaries of posts that are sent to you periodically. Digests can be sent daily, weekly or monthly at an hour of the day you select. You can specify those particular forums for which you want posts or by default you can elect to receive all posts for all forums for which you can read. You can, of course, cancel your digest subscription at any time by simply coming back to this page. Most users find digests to be very useful. We encourage you to give it a try!',
	...
	'DIGESTS_FORMAT_ERROR'				=> 'Digests mailer was called with an invalid user_digest_format of %s',
	...
	'DIGESTS_INTRODUCTION' 				=> 'Here is the latest digest of messages posted on %s forums. Please visit the forum and join the discussion!',
	...
	'DIGESTS_SEND_HOUR_EXPLAIN'			=> 'The digest arrival time is the time based on the time zone you set in your board preferences.',
	...
	'DIGESTS_SORT_BY_ERROR'				=> 'Digests mailer was called with an invalid user_digest_sortby = %s',
	...
	'DIGESTS_TERMINATED_ABNORMALLY'		=> 'Digests mailer terminated abnormally',
	'DIGESTS_TIME_ERROR'				=> 'Digests mailer calculated a bad digest send hour of %s',
