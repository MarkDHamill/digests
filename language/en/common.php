...
$lang = array_merge($lang, array(
	...
	'DIGESTS_DISCLAIMER'				=> 'You can change or delete your subscription from the forum&rsquo;s <a href="%1$sucp.%3$s">User Control Panel</a>. If you have questions or feedback on your digests please send it to the <a href="mailto:%4$s?subject=Digests">%2$s webmaster</a>.',
	...
	'DIGESTS_INTRODUCTION' 				=> 'Here is the latest digest of posts from %s forums. Do <em>not</em> reply to this email to reply to topics, posts or private messages. But please <em>do</em> visit the forum and join the discussion! (If the format of the digest looks off, make sure to download all remote content.)',
	...
	'DIGESTS_MAX_DISPLAY_WORDS_EXPLAIN'	=> 'To ensure consistent rendering, if a post must be truncated the HTML markup will be removed from the post. Leave blank or set to 0 to allow the full post text to appear. If the &ldquo;Show no post text at all&rdquo; option is checked, this field is ignored and no post text will appear in the digest.',
