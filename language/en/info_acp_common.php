...
// For some timezone offset magic
...
$lang = array_merge($lang, array(
	...
	'ACP_DIGESTS_GENERAL_SETTINGS_EXPLAIN'					=> 'These are the general digests settings.',
	...
	'ACP_DIGESTS_TEST_EXPLAIN'								=> 'This feature allows you to manually run digests, for initial testing or troubleshooting. You can also use it to recreate digests for a particular date and hour. The board timezone (currently ' . $timeOffset . ' GMT) is used when calculating the date and hour. Please note that for digests to run hourly, you must <a href="https://wiki.phpbb.com/Modular_cron#Use_system_cron">set up</a> and <a href="'. $server_settings_url . '">enable</a> phpBB&apos;s <strong>system cron</strong> feature. For more information, see the FAQ for the Digests extension on the forums at phpbb.com.',

	'DIGESTS'												=> 'Digests',
	'DIGESTS_ALL'											=> 'All',
	'DIGESTS_ALL_ALLOWED_FORUMS'							=> 'All allowed forums',
	'DIGESTS_ALL_SUBSCRIBED'								=> 'A total of %s members were mass subscribed to receive digests',
	'DIGESTS_ALL_UNSUBSCRIBED'								=> 'A total of %s members were mass unsubscribed to receive digests',
	'DIGESTS_BALANCE_LOAD'									=> 'Balance load',
	'DIGESTS_BASED_ON'										=> '(Based on %s GMT)',
	'DIGESTS_BLOCK_IMAGES'									=> 'Block images',
	'DIGESTS_BLOCK_IMAGES_EXPLAIN'							=> 'Prohibits all images from appearing in digests, including images as attachments. If bandwidth is a concern, you may want to enable this feature.',
	'DIGESTS_CHANGE_SUBSCRIPTION'							=> 'Change subscription',
	...
	//'DIGESTS_ENABLED'										=> 'Enable Digests',
	//'DIGESTS_ENABLED_EXPLAIN'								=> 'If you disable digests, the interface in the User Control Panel will disappear by disabling the module category. In addition, digests will no longer be sent out. However, all user digest settings are retained.',
	'DIGESTS_ENABLE_AUTO_SUBSCRIPTIONS'						=> 'Enable automatic subscriptions',
	'DIGESTS_ENABLE_AUTO_SUBSCRIPTIONS_EXPLAIN'				=> 'If you want new users to automatically get digests, select Yes. The Board&apos;s default settings for digests will be automatically used. (These are set in the digest User default settings). Enabling this option will <em>not</em> create subscriptions for currently unsubscribed users or for new members who chose not to receive a digest during registration. You can set these individually using the Edit Subscribers function, or globally with the Mass subscribe/unsubscribe option.',
	...
	'DIGESTS_ENABLE_LOG_EXPLAIN'							=> "If Yes, all digest actions will be written to the Admin log (found on the Maintenance tab). This is helpful for solving digest problems since it indicates what the digests mailer did and when. However, it will quickly result in a very long Admin log since at least two entries will be written every hour to the log.",
	...
	//'DIGESTS_INCLUDE_INACTIVE'								=> 'Include inactive users',
	//'DIGESTS_INCLUDE_INACTIVE_EXPLAIN'						=> 'This will subscribe or unsubscribe inactive users, such as those that have not completed registration.',
//	'DIGESTS_KEY_VALUE'										=> 'Key value',
//	'DIGESTS_KEY_VALUE_EXPLAIN'								=> 'Bear in mind this is open text and not encrypted. Keep it simple. Avoid multiple words, spaces and special characters. Example: qwertyuiop',
	'DIGESTS_LAST_SENT'										=> 'Digest last sent',
	'DIGESTS_LATEST_VERSION_INFO'							=> 'The latest available version is <strong>%s</strong>.',
	'DIGESTS_LIST_USER'     								=> '1 User',
	'DIGESTS_LIST_USERS'    								=> '%s Users',
	...
	'DIGESTS_NEW_SUBSCRIBERS'								=> ' %s users were subscribed to receive digests: %s.',
	'DIGESTS_NONSUBSCRIBER'									=> 'Nonsubscriber',
...
//	'DIGESTS_REQUIRE_KEY'									=> 'Require key parameter to run digests mailer',
//	'DIGESTS_REQUIRE_KEY_EXPLAIN'							=> 'This is an extra security precaution you can enable. If enabled, digests mailer will only send digests if the key parameter is specified and the key matches the key value you define below. You will have to program your cron job or its equivalent to use the key.',
	'DIGESTS_RUN_TEST'										=> 'Run the mailer',
	//'DIGESTS_RUN_TEST_EXPLAIN'								=> 'This must be Yes for any action.',
	...
	'DIGESTS_RUN_TEST_CLEAR_SPOOL_EXPLAIN'					=> 'If Yes, any files in this extension&apos;s cache folder will be erased. This is a good thing to do to ensure a previous cache of digests is not accessible. If Yes, this will occur if you submit the form, regardless of whether you run the mailer too.',
	'DIGESTS_RUN_TEST_DAY'									=> 'Simulation day in the month',
	'DIGESTS_RUN_TEST_DAY_EXPLAIN'							=> 'Enter a whole number from 1 to 31. If the year, month and day is in the future of course digests will be empty. Of course don&apos;t use a day that does not logically belong in the month, like February 31.',
	...
	'DIGESTS_RUN_TEST_MONTH_EXPLAIN'						=> 'Enter a whole number from 1 to 12. Normally this should be set to the current month. If the year and month is in the future of course digests will be empty.',
	...
	'DIGESTS_SHOW'											=> 'Show',
	'DIGESTS_SHOW_OUTPUT'									=> 'Show output',
	'DIGESTS_SHOW_OUTPUT_EXPLAIN'							=> "If yes, when digests mailer is run, messages will be written to the screen indicating the who got a digest and when. Typically these messages are not seen since the program is run automatically. It is suggested setting this to Yes until you automate the process and then setting it to No.",
	'DIGESTS_SHOW_EMAIL'									=> 'Show email address',
	'DIGESTS_SHOW_EMAIL_EXPLAIN'							=> "If Show output is enabled and Show email address is enabled as well, the subscriber's email address is shown in output to the screen. It is suggested that this be <em>promptly</em> turned off after troubleshooting, as it introduces a potential security issue.",
	'DIGESTS_SOCKET_FUNCTIONS_DISABLED'						=> 'Socket functions are currently disabled.',
	'DIGESTS_SORT_ORDER'									=> 'Sort order',
	'DIGESTS_STOPPED_SUBSCRIBING'							=> 'Stopped subscribing',
	'DIGESTS_SUBSCRIBE'										=> 'Subscribe using defaults',
	...
	'DIGESTS_SUBSCRIBER'									=> 'Subscriber',
	'DIGESTS_SUBSCRIBERS'									=> 'Subscribers',
	'DIGESTS_SUBSCRIBER_DETAIL'								=> 'Digest subscriber detail',
	...
	'DIGESTS_UNSUBSCRIBE_MARKED'							=> 'Unsubscribe Marked',
	...
	'DIGESTS_USER_DIGESTS_MAX_POSTS_EXPLAIN'				=> 'If set at zero, will allow any number of posts. Please note that the no digest will ever contain more than your setting for maximum posts allowed in any digest (above).',
	...
	'DIGESTS_USER_DIGESTS_RANDOM_HOUR'						=> 'Random hour',
	...
	'DIGESTS_VERSION_NOT_UP_TO_DATE'						=> 'This version of phpBB Digests is not current. Updates are available on the <a href="%s">Digests website</a>.',
	'DIGESTS_VERSION_UP_TO_DATE'							=> 'This version of phpBB Digests is up-to-date, no update available.',
	'DIGESTS_WEEKLY_DIGESTS_DAY'							=> 'Select the day of the week for sending out weekly digests',
	'DIGESTS_WITH_SELECTED'									=> 'With selected',

	'LOG_CONFIG_DIGESTS_BAD_DATE_PARAM'						=> '<strong>Digest exception: A bad URL date parameter of "%s" was encountered. This must be expressed as an ISO-8601 date, i.e. in a YYYY-MM-DD format.</strong>',
	'LOG_CONFIG_DIGESTS_BAD_DIGESTS_TYPE'					=> '<strong>Digest exception: A bad digest type of "%s" was encountered</strong>',
	'LOG_CONFIG_DIGESTS_BAD_HOUR_PARAM'						=> '<strong>Digest exception: A bad URL hour parameter of "%s" was encountered. This must be an integer from 0 to 23.</strong>',
//	'LOG_CONFIG_DIGESTS_BAD_KEY_VALUE'						=> "<strong>When running digests mailer, the \"key\" parameter given had an invalid value of \"%s\". Program terminated.</strong>",
	'LOG_CONFIG_DIGESTS_BAD_SEND_HOUR'						=> '<strong>User %s digest send hour is invalid. It is %s. The number should be >= 0 and < 24.</strong>',
	'LOG_CONFIG_DIGESTS_BALANCE_LOAD'						=> "<strong>The digests balance load function was run successfully</strong>",
	...
	'LOG_CONFIG_DIGESTS_FILTER_ERROR'						=> '<strong>Digests mailer was called with an invalid user_digest_filter_type = %s</strong>',
	'LOG_CONFIG_DIGESTS_FORMAT_ERROR'						=> '<strong>Digests mailer was called with an invalid user_digest_format of %s</strong>',
	'LOG_CONFIG_DIGESTS_GENERAL'							=> '<strong>Altered Digest general settings</strong>',
	'LOG_CONFIG_DIGESTS_LOG'								=> '<strong>Altered Digest log settings</strong>',
	...
	'LOG_CONFIG_DIGESTS_LOG_ENTRY_GOOD'						=> '<strong>A digest was %s %s (%s) containing %s posts and %s private messages</strong>',
	'LOG_CONFIG_DIGESTS_LOG_ENTRY_GOOD_NO_EMAIL'			=> '<strong>A digest was %s %s containing %s posts and %s private messages</strong>',
	...
	'LOG_CONFIG_DIGESTS_LOG_EMAILED'						=> '<strong>All digests for this hour have been e-mailed</strong>',
	...
	//'LOG_CONFIG_DIGESTS_NEED_TWO_PARAMS'					=> "<strong>Digest exception: Both a date and an hour parameter must be specified for an irregular run of mail_digests.$phpEx Only one of these was provided.</strong>",
	'LOG_CONFIG_DIGESTS_NO_ALLOWED_FORUMS'					=> '<strong>Digest exception: User "%s" cannot access any forums so no digest can be created</strong>',
	'LOG_CONFIG_DIGESTS_NO_BOOKMARKS'						=> '<strong>Digest exception: A digest for bookmarked topics was requested by "%s" but the user had no bookmarked topics</strong>',
	'LOG_CONFIG_DIGESTS_NOT_ENABLED'						=> '<strong>Digests are currently not enabled, so no digests were sent for this hour.</strong>',
	'LOG_CONFIG_DIGESTS_SEND_MASS_EMAIL_ERROR'				=> '<strong>Unable to send digest mass suscribe/unsubscribe email to %s</strong>',
	'LOG_CONFIG_DIGESTS_SORT_BY_ERROR'						=> "<strong>Digests mailer was called with an invalid user_digest_sortby = %s</strong>",
	'LOG_CONFIG_DIGESTS_USER_DEFAULTS'						=> '<strong>Altered Digest user default settings</strong>',
	'LOG_CONFIG_DIGESTS_TEST'								=> '<strong>Manually ran the mailer</strong>',
	'LOG_CONFIG_DIGESTS_WRITE_LOG_ENTRY_ERROR'				=> '<strong>Digest exception: write_log_entry called with an unhandled type of "%s"</strong>',
