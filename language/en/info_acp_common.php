...
$lang = array_merge($lang, array(
	...
	'DIGESTS_MAX_CRON_HOURS'								=> 'Maximum hours to process per mailer call',
	'DIGESTS_MAX_CRON_HOURS_EXPLAIN'						=> 'Use 0 (zero) to allow unlimited hours to be processed when the mailer is run. If you are using a virtual or dedicated server, it is should not necessary to change this setting. However, if you are on <strong>shared hosting</strong> then global resource limits imposed by your web host (resulting in HTTP errors or exceeding outgoing mail quotas) may occur. If this happens it may be necessary to set this value to a low number for all digests to go out successfully.',
