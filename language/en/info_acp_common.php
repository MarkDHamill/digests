...
//	'DIGESTS_REQUIRE_KEY_EXPLAIN'							=> 'This is an extra security precaution you can enable. If enabled, digests mailer will only send digests if the key parameter is specified and the key matches the key value you define below. You will have to program your cron job or its equivalent to use the key.',
	...
	'LOG_CONFIG_DIGESTS_BAD_DIGESTS_TYPE'					=> '<strong>Digest exception: A bad digest type of "%s" was encountered for %s</strong>',
...
//	'LOG_CONFIG_DIGESTS_BAD_KEY_VALUE'						=> "<strong>When running digests mailer, the \"key\" parameter given had an invalid value of \"%s\". Program terminated.</strong>",
	...
	'LOG_CONFIG_DIGESTS_SIMULATION_DATE_TIME'				=> '<strong>Administrator chose to create digests for %s at %s:00 board time.</strong>',
