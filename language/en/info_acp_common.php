...
$lang = array_merge($lang, array(
	...
	'DIGESTS_REQUIRE_KEY'									=> "Require key parameter to run mail_digests.php",
	'DIGESTS_REQUIRE_KEY_EXPLAIN'							=> "This is an extra security precaution you can enable. If enabled, mail_digests.$phpEx will only send digests if the key parameter is specified and the key matches the key value you define below. You will have to program your cron job or its equivalent to use the key. Example of the resulting URL: http://www.example.com/phpBB3/mail_digests.$phpEx?key=qwertyuiop",
	...
	'DIGESTS_SHOW_OUTPUT_EXPLAIN'							=> "If yes, when mail_digests.$phpEx is run, messages will be written to the screen indicating the who got a digest and when. Typically these messages are not seen since the program is run automatically. It is suggested setting this to Yes until you automate the process and then setting it to No.",
	...
	'LOG_CONFIG_DIGESTS_BAD_KEY_VALUE'						=> "<strong>When running mail_digests.$phpEx, the \"key\" parameter given had an invalid value of \"%s\". Program terminated.</strong>",
	'LOG_CONFIG_DIGESTS_BALANCE_LOAD'						=> "<strong>The digests balance load function was run successfully</strong>",
	'LOG_CONFIG_DIGESTS_BOARD_DISABLED'						=> "<strong>mail_digests.$phpEx run was attempted, but stopped because the board is disabled.</strong>",
	...
	'LOG_CONFIG_DIGESTS_LOG_START'							=> "<strong>Starting mail_digests.$phpEx</strong>",
	'LOG_CONFIG_DIGESTS_LOG_END'							=> "<strong>Ending mail_digests.$phpEx</strong>",
