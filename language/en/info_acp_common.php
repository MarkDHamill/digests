...
$lang = array_merge($lang, array(
	...
	'DIGESTS_MAILER_SPOOLED'								=> 'Any digests created for the date and hour were saved in the store/digests directory.',
	...
	'DIGESTS_RUN_TEST_CLEAR_SPOOL'							=> 'Clear the store/digests directory',
	'DIGESTS_RUN_TEST_CLEAR_SPOOL_ERROR'					=> 'Could not remove all the files in the store/digests directory. This may be due to a permissions issue. The file permissions on the directory should be set to publicly writeable (777 on Unix-based systems).',
	'DIGESTS_RUN_TEST_CLEAR_SPOOL_EXPLAIN'					=> 'If Yes, any files in the store/digests directory will be erased. This is a good thing to do to ensure previous digest files are not accessible. This action is done before any new digests are written to this directory.',
	...
	'LOG_CONFIG_DIGESTS_CACHE_CLEARED'						=> '<strong>The store/digests directory was emptied',
	'LOG_CONFIG_DIGESTS_CLEAR_SPOOL_ERROR'					=> '<strong>Unable to clear files in the store/digests directory. This may be due to a permissions issue or an incorrect path. The file permissions on the directory should be set to publicly writeable (777 on Unix-based systems).</strong>',
	'LOG_CONFIG_DIGESTS_DIRECTORY_CREATE_ERROR'				=> '<strong>Unable to create a store/digests directory. This may be due to a permissions issue with your forum&apos;s store folder.</strong>',
	...
	'LOG_CONFIG_DIGESTS_LOG_ENTRY_GOOD'						=> '<strong>A digest was %s %s (%s) for hour %d UTC containing %d posts and %d private messages</strong>',
	'LOG_CONFIG_DIGESTS_LOG_ENTRY_GOOD_DISK'				=> '<strong>A digest was written to the store/digests directory with a file name of %s. The digest was NOT emailed, but was placed here for analysis.</strong>',
	'LOG_CONFIG_DIGESTS_LOG_ENTRY_GOOD_NO_EMAIL'			=> '<strong>A digest was %s %s for hour %d UTC containing %d posts and %d private messages</strong>',
