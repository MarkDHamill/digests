...
$lang = array_merge($lang, array(
	...
	'DIGESTS_MIGRATE_UNSUPPORTED_VERSION' 					=> 'Los Upgrades de las modificaciones de los resúmenes (para phpBB 3.0) están soportados desde la versión 2.2.6 en adelante. Tienes la versión %s. La extensión no puede ser migrada o instalada. Por favor busca ayuda en el foro de la extensión en phpbb.com.',
