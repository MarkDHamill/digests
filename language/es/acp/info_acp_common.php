...
$lang = array_merge($lang, array(
	...
	'ACP_DIGESTS_EDIT_SUBSCRIBERS_EXPLAIN'					=> 'Esta página te permite ver quien recibe o no recibe los resúmenes. Puedes suscribir o desuscribir miembros y editar los detalles del resumen de cada miembro. Marcando	 las filas con el checkbox en la primera columna, puedes suscribir esos miembros con sus valores por defecto o desuscribirlos. Hazlo seleccionando los controles apropiados al final de la página y dandole a enviar. Ten en cuenta que puedes utilizar esos controles para ordenar y filtrar la lista en conjunto con el botón de Go.',
	...
	'ACP_DIGESTS_TEST_EXPLAIN'								=> 'Esta funcionalidad te permite ejecutar los resumenes para hacer pruebas iniciales o para resolver problemas. La puedes utilizar para recrear resumenes para horas en las que no se hayan enviado. Solo una hora de resumenes ha sido creada y no se han cambiado datos del usuario.<br><br> <strong>Suscriptores que pueden recibir resumen para esta hora:</strong> %s',
	...
	'LOG_CONFIG_DIGESTS_BOARD_DISABLED' 					=> '<strong>El mailer de los resúmenes se ha lanzado, pero se ha parado porque el foro está deshabilitado.</strong>',
	...
	'LOG_CONFIG_DIGESTS_EMAILING_FAILURE' 					=> '<strong>No se puede enviar el resumen para la fecha %s hora %d UTC</strong>',
	'LOG_CONFIG_DIGESTS_EXCEPTION_ERROR'					=> '<strong>La siguiente excepción de PHP try/catch ha ocurrido: %s</strong>',
	...
	'LOG_CONFIG_DIGESTS_LOG_START' 							=> '<strong>Iniciando el mailer de los resumenes</strong>',
	'LOG_CONFIG_DIGESTS_LOG_END' 							=> '<strong>Acabando el mailer de los resumenes</strong>',
	...
	'LOG_CONFIG_DIGESTS_SIMULATION_DATE_TIME'				=> '<strong>El administrador ha escogido de crear resumenes para el el tiempo del foro %s.</strong>',
