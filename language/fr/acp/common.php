...
'DIGESTS_LOWERCASE_DIGEST_TYPE_EXPLAIN'					=> 'En Anglais, le titre du résumé sera par exemple &ldquo;My board name Daily Digest&rdquo;. Dans certaines langues &ldquo;Digest Daily&rdquo; précède le nom du forum. En indiquant Oui, la fréquence du résumé apparaîtra ainsi &ldquo;Résumé journalier de mon forum&rdquo;, avec la première lettre de la fréquence d&apos;envoi en minuscule.',
	...
	'DIGESTS_RUN_TEST_CLEAR_SPOOL_EXPLAIN'					=> 'Si vous choisissez Oui, tous les fichiers dans le dossier store/phpbbservices/digests seront effacés avant que tout nouveau résumé ne soit écrit dans ce dossier.',
	...
	'DIGESTS_RUN_TEST_SPOOL_EXPLAIN'						=> 'Évite que les résumés ne soient envoyés par courriels. À la place chaque résumé est écrit dans un fichier du dossier store/phpbbservices/digests dont le nom à le format suivant : nom d&apos;utilisateur-aaaa-mm-jj-hh-uniqueID.html ou nom d&apos;utilisateur-aaaa-mm-jj-hh-uniqueID.txt. (les fichiers avec un suffixe .txt sont des résumés textuel uniquement.) nom d&apos;utilisateur est le nom d&apos;utilisateur sur le forum phpBB. aaaa indique l&apos;année, mm le mois, jj le jour dans le mois et hh l&apos;heure. La Date et l&apos;heure dans le nom du fichier sont basés sur le temps coordonné universel (UTC). Si vous simulez un autre jour ou une autre heure pour envoyer les résumés à l&apos;aide des champs ci-dessous, les noms de fichier utiliseront cette date et cette heure converties en UTC. Pour visualiser ces fichiers, commencez par les télécharger dans un dossier local. Visualisez le fichier dans un navigateur en utilisant son mode local : CTRL+O ou CMD+O (Mac). <em>Nota</em> : utilisez la lettre O, pas le chiffre 0.',
	'DIGESTS_RUN_TEST_TIME_USE'								=> 'Simuler le mois et l&apos;heure, ou le jour de la semaine et l&apos;heure d&apos;envoi des résumés',
	'DIGESTS_RUN_TEST_TIME_USE_EXPLAIN'						=> 'Si le réglage est Oui, les éléments de simulation ci-dessous seront utilisés pour envoyer un résumé, comme s&apos;il s&apos;agissait du mois, de l&apos;heure et du jour de la semaine spécifié, basé sur le fuseau de votre serveur. (Vous pouvez déterminer le fuseau de votre serveur en visualisant l&apos;information de la fonction PHP dans le PCA et en recherchant le fuseau horaire par défaut.). Si Non, la date et l&apos;heure courante seront utilisées.',
